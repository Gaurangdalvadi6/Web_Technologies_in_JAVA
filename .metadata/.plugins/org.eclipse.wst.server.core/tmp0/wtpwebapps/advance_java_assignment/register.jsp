...
<body>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="StudentController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="gaurang@email.com" name="email"
                            required="">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Mobile</label>
                        <input type="tel" class="form-control" placeholder="1234567890" name="mobile"
                            required="" min="10" maxlength="10">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Gender</label>
                        <input type="text" class="form-control" placeholder="Male/Female" name="gender" required="">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Password</label>
                        <input type="password" class="form-control" placeholder="*****" name="password" required="">
                    </div>
                    <button type="submit" class="btn button-style-w3" value="register" name="action">Register</button>
                </form>
            </div>
            <!-- //register -->
        </div>
    ...
    <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">© 2023 Tops Technologies School. All
                    Rights Reserved | Design by
                    <a href="https://github.com/Gaurangdalvadi6" target="_blank">Mr_Rambo_King</a>
                </p>
                <!-- //copyright -->
                <!-- social icons -->
