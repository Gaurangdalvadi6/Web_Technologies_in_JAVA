...
<body>
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">New Password </h3>
            <form action="StudentController" method="post">
                ...
                <%String email = (String)request.getAttribute("email"); %>
                    ...
                    <button type="submit" class="btn button-style-w3" value="Update Password" name="action">Update Password	</button>
                    </form>
                     </div>
            <!-- //login -->
        </div>
