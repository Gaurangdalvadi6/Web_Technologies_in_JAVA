    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Profile</h3>
                <form action="StudentController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control"  name="mobile" min="10" maxlength="10" value="<%=s.getMobile()%>">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Gender</label>
                        <input type="text" class="form-control" name="gender" value="<%=s.getGender() %>>">
                    </div>
                    <button type="submit" class="btn button-style-w3" value="update" name="action">Update</button>
                </form>
            </div>
            <!-- //register -->
        </div>
